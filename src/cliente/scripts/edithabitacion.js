document.addEventListener('DOMContentLoaded', () => {
    ...
    if (modo === 'editar' && HabInfo) {
        ...
        fetch('../../servidor/habitacion.php',{
            method: 'POST',
            body: new URLSearchParams({action: 'obtenerImagenes', id: HabInfo.codigo})
        })
        ...
        .then(imagenes => {
            ...
            document.getElementById('btn_eliminar_imagen').addEventListener('click', function(){
                    ...
                    if(confirm("¿Estás seguro de que deseas eliminar esta imagen?")){
                        ...
                        .then(data => {
                            ...
                            if(swiper.slides.length > 0){
                                swiper.slideTo(swiper.activeIndex === swiper.slides.length ? swiper.slides.length -1 : swiper.activeIndex);
                                actualizarImagenSeleccionada();
                            } else {
            ...
            const btnImagenPrederteminada = document.getElementById('btn_predeterminada_imagen');
                ...
                btnImagenPrederteminada.addEventListener('click', function(){
                    if(idImagenSeleccionada){
                        ...
                        .then(data => {
                            ...
                            document.getElementById('imagen-prev').src = document.querySelector('.swiper-slide.seleccionada img').src;
                        })
                        .catch(error => {
                        });
                    } else {
                        alert("Por favor, selecciona una imagen para establecer como predeterminada.");
                    }
                });
