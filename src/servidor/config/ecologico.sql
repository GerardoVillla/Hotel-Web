...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2024 a las 21:10:46
...
(1, 'Cascada Secreta', 'Deluxe', 1, 10, 'Habitación con ambiente de cascada, incluye sonidos relajantes de agua.', 2150, 3, 'cascada-secreta.jpg'),
...
(8, 'Refugio Verde', 'Estandar', 1, 2, 'Habitación con vista al jardín, decorada con materiales reciclados y productos ecológicos.', 1200, 2, 'refugio-verde.jpg'),
(9, 'Bambú Natural', 'Estandar', 1, 5, 'Habitación inspirada en el bambú, con un estilo rústico y sostenible.', 1300, 2, 'bambu-natural.jpg');
