...
<head>
	...
	<link rel="stylesheet" href="/ecologico/src/cliente/css/home-styles.css">
...
<body>
	<header>
		...
		<nav>
			<ul>
				...
				<li id="btn-reservar"><a href="reservar.html">Iniciar Sesion</a></li>
			</ul>
		</nav>
	</header>
	...
	<div class="contenido">
		<div id="img-home">
			<img src="/ecologico/src/cliente/recursos/img/principal/home.png" alt="img de bienvenida">
		</div>
		<section id="bienvenida-tarjeta">
			...
			<img src="/ecologico/src/cliente/recursos/img/principal/bienvenida.png" alt="img ek' balam">
		</section>
		<section id="desglose-habitaciones">
			...
			<div class="carrusel">
				<a class="tarjeta-habitacion" href="#">
					<img src="/ecologico/src/cliente/recursos/img/principal/estandar.jpg" alt="img habitacion estandar">
				...
				<a class="tarjeta-habitacion" href="#">
					<img src="/ecologico/src/cliente/recursos/img/principal/deluxe.jpg" alt="img habitacion deluxe">
					<div class="descripcion-articulo">
						<h2>Deluxe</h2>
						<p>Espacio confortable, decorado con materiales sostenibles, iluminación natural, sistema de
				...
				<a class="tarjeta-habitacion" href="#">
					<img src="/ecologico/src/cliente/recursos/img/principal/suite.jpg" alt="img habitacion suite">
					<div class="descripcion-articulo">
						<h2>Suite</h2>
						<p>Espacio confortable, decorado con materiales sostenibles, iluminación natural, sistema de
							reciclaje, y productos orgánicos para una experiencia armoniosa.</p>
